...
contract Attacker {
    ...
    receive() external payable {
        ...
        // fees, no real profit could transfer usdc into zap for zap to be able
        // to pay back the original caller but that is also just shuffling your
        // own assets around cant call reenter into executeOperation because of
        // access controls
    }
